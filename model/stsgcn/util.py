...
def construct_adj(A, steps):
    N = len(A)  # 170
    adj = np.zeros([N * steps] * 2)  # (510 * 510)全0矩阵
    for i in range(steps):
        adj[i * N: (i + 1) * N, i * N: (i + 1) * N] = A  # [0:170, 0:170]  [170:340, 170:340]  [340:510, 340:510]
    for i in range(N):# i=169 k=0
        for k in range(steps - 1):
            adj[k * N + i, (k + 1) * N + i] = 1  # [0, 170] [170, 340] / [1, 171] [171, 341] / ... / [169, 339] [339, 509]
            adj[(k + 1) * N + i, k * N + i] = 1  # 与上面对称 [170, 0] [340, 170]
